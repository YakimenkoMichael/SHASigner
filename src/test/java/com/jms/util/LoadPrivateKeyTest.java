...
class LoadPrivateKeyTest {
    private LoadPrivateKey loadPrivateKey = new LoadPrivateKey();

    @Test
    void test_convert2Hex() throws IOException {

        final String hex = loadPrivateKey.convert2Hex("src/test/resources/privatekey.der");
        assertEquals("308204BC020100300D06092A864886F70D0101010500048204A6308204A20201000282010100C289ACC4" +
